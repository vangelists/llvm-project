...
CommandObject::ArgumentTableEntry CommandObject::g_arguments_data[] = {
    ...
    { eArgTypeTracingBookmarkName, "bookmark-name", CommandCompletions::eNoCompletion, { nullptr, false }, "The name of a thread tracepoint bookmark." },
    { eArgTypeTracingBookmarkID, "bookmark-id", CommandCompletions::eNoCompletion, { nullptr, false }, "The ID of a thread tracepoint bookmark." },
